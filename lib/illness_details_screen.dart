...
class IllnessDetailsScreen extends StatelessWidget {
  ...
  final Map<String, Map<String, String>> illnessData = {
    ...
    "Ear Mites": {
      "symptoms": "• Dark, waxy ear discharge\n• Scratching ears, head shaking\n• Ear inflammation",
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  illnessInfo['symptoms'] ?? 'No symptoms information available',
              ...
              Container(
                ...
                child: Text(
                  illnessInfo['treatment'] ?? 'No treatment information available',
                  style: TextStyle(fontSize: 16),
                ),
              ),
            ],
